// You will need GDK installed to compile this. It can be found here:  https://github.com/microsoft/gdk
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"SimInTWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimInTWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
            nullptr, nullptr, hInstance,
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"SimInTWindowClass", g_szAppName, WS_POPUP,
